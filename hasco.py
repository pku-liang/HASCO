...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--instinct', type=str, choices=["CONV", "GEMM"],
                        required=True, help="the type of hardware instict (GEMM/CONV)")
    ...
    constraints = {"latency": args.latency, "power": args.power, "area": args.area}  # TODO

    print(f"Testing accelerators with {args.instinct} intrinsic ...")
